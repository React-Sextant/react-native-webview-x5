...
@ReactModule(name = RNCWebViewModule2.MODULE_NAME)
public class RNCWebViewModule2 extends ReactContextBaseJavaModule implements ActivityEventListener {
  public static final String MODULE_NAME = "RNCWebView2";
  ...
  public RNCWebViewModule2(ReactApplicationContext reactContext) {
    super(reactContext);
  ...
  public void startPhotoPickerIntent(ValueCallback<Uri> filePathCallback, String acceptType) {
    ...
    if (chooserIntent.resolveActivity(getCurrentActivity().getPackageManager()) != null) {
      ...
      Log.w("RNCWebViewModule2", "there is no Activity to handle this Intent");
    }
  }
